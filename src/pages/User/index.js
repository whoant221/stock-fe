            ...
            <div className={cx('songs-wrapper')}>
                <div className={cx('nav-wrapper')}>
                    <nav className={cx('nav-list')}>
                        <NavLink className={(nav) => cx('nav-item', { active: nav.isActive })} to='#'>
                            <h5 className={cx('nav-title')}>Bài hát</h5>
                        </NavLink>
                        <NavLink className={(nav) => cx('nav-item', { active: nav.isActive })} to='./podcast'>
                            <h5 className={cx('nav-title')}>Podcast</h5>
                        </NavLink>
                        <NavLink className={(nav) => cx('nav-item', { active: nav.isActive })} to='./album'>
                            <h5 className={cx('nav-title')}>Album</h5>
                        </NavLink>
                        <NavLink className={(nav) => cx('nav-item', { active: nav.isActive })} to='./mv'>
